...
- [3. SDTL 技术架构解析](#3-sdtl-技术架构解析)
   - [3.1 健康指标（HIs）的提取与筛选](#31-健康指标his的提取与筛选)
   - [3.2 自注意力机制（Self-Attention）的优势](#32-自注意力机制self-attention的优势)
   - [3.3 迁移学习策略：预训练与微调](#33-迁移学习策略预训练与微调)
...
## 3. SDTL 技术架构解析
论文提出的自注意力深度迁移学习（SDTL）框架的思路为“通用退化知识提取 + 目标场景快速适配”。

<div align="center">
  <img src="https://github.com/user-attachments/assets/6b6e863d-13f0-4e45-a937-929d0944dde3" />
  <p><em>图1 基于深度迁移学习的在线健康状态（SOH）估计框架</em></p>
</div>
...
**表 1 多源健康指标（Health Indicators）提取列表**

| 编号 | 指标描述 (Description) | 提取来源 | 是否选中 |
| :---: | :--- | :--- | :---: |
| HI1-4 | 充电恒流/恒压段的容量与时间 | Charge Curve | |
| **HI5** | **3.8–3.4 V 放电区间的恒流放电时间** | **Discharge Curve** | **✅** |
| HI6 | IC 曲线峰值 | IC Curve | |
| HI7-12 | 充电电压的统计特征 (均值/方差等) | Voltage | |
| HI13-16| 充电电流的统计特征 (均值/方差等) | Current | |
| **HI17**| **充电电流的信息熵 (Entropy)** | **Current** | **✅** |
| **HI18**| **充电电流的变化斜率 (Slope)** | **Current** | **✅** |

### 3.2 自注意力机制（Self-Attention）的优势

<div align="center">
  <img src="https://github.com/user-attachments/assets/709cc939-833a-4985-9ad4-5ea93ab8ee60" />
  <p><em>图2 基于自注意力的模型结构</em></p>
</div>
...
| 系列 | 电池编号 | 正极材料 | 充电倍率 | 放电倍率 | 温度 | 用途 |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| 1 | A1, A2 | **NCM** | 1C | 2C, 1C | 24 °C | **源域预训练** |
| 2 | B1-B4 | **NCA** | 0.75C | 1C | 24 °C | 跨材料测试 |
| 3 | B5-B7 | **NCA** | 0.75C | **2C** | 24 °C | 跨倍率测试 |
| 4 | B8-B10 | **NCA** | 0.75C | 1C | **4 °C** | **跨温度测试** |
...
<div align="center">
  <img src="https://github.com/user-attachments/assets/72922a9f-3e71-4036-988f-f8404edd6dd3" />
  <p><em>图3 (a) 三组电池系列的 SOH 估算结果 (b) 低温工况拟合曲线 (c) 模型误差分布小提琴图</em></p>
</div>

## 6. 结论
该研究展示了自注意力机制与深度迁移学习结合的优越性：
1.  **极速适配**：只需极少量的早期退化数据（10%），即可完成对新类型电池的建模，大幅缩短了BMS的调试周期。
